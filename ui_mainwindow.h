...
public:
    ...
    QAction *actRestoreStatusBar;
    QAction *action_clear;
    QWidget *centralWidget;
    QVBoxLayout *verticalLayout;
    MyGraohicsView *graphicsView;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actRestoreStatusBar = new QAction(MainWindow);
        actRestoreStatusBar->setObjectName(QStringLiteral("actRestoreStatusBar"));
        QIcon icon18;
        icon18.addFile(QStringLiteral(":/images/images/018.JPG"), QSize(), QIcon::Normal, QIcon::Off);
        actRestoreStatusBar->setIcon(icon18);
        action_clear = new QAction(MainWindow);
        action_clear->setObjectName(QStringLiteral("action_clear"));
        QIcon icon19;
        icon19.addFile(QStringLiteral(":/images/images/DELETE.BMP"), QSize(), QIcon::Normal, QIcon::Off);
        action_clear->setIcon(icon19);
        ...
        graphicsView = new MyGraohicsView(centralWidget);
        ...
        mainToolBar->addAction(actRestoreStatusBar);
...
#endif // QT_NO_TOOLTIP
        actRestoreStatusBar->setText(QApplication::translate("MainWindow", "\346\201\242\345\244\215\347\212\266\346\200\201\346\240\217\344\275\215\347\275\256", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actRestoreStatusBar->setToolTip(QApplication::translate("MainWindow", "\346\201\242\345\244\215\347\212\266\346\200\201\346\240\217\344\275\215\347\275\256", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        action_clear->setText(QApplication::translate("MainWindow", "\346\270\205\347\251\272\345\233\276\345\275\242", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        action_clear->setToolTip(QApplication::translate("MainWindow", "\346\270\205\347\251\272\345\233\276\345\275\242", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
